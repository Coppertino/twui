...
NSString *const TUICollectionElementKindSectionHeader = @"TUICollectionElementKindSectionHeader";
NSString *const TUICollectionElementKindSectionFooter = @"TUICollectionElementKindSectionFooter";

// this is not exposed in UICollectionViewFlowLayout
NSString *const TUIFlowLayoutCommonRowHorizontalAlignmentKey = @"TUIFlowLayoutCommonRowHorizontalAlignmentKey";
NSString *const TUIFlowLayoutLastRowHorizontalAlignmentKey = @"TUIFlowLayoutLastRowHorizontalAlignmentKey";
NSString *const TUIFlowLayoutRowVerticalAlignmentKey = @"TUIFlowLayoutRowVerticalAlignmentKey";
...
- (void)updateItemsLayout {
    ...
    NSRect scrollViewBounds = self.collectionView.bounds;
	if (_data.horizontal) {
